...
namespace Rca301Emulator.UserInterface
{
    class Win32
    {
        ...
        public static extern int SetScrollInfo(IntPtr hWnd, SBFlags fnBar, [In] ref SCROLLINFO lpsi, bool fRedraw);

        public static int SetScrollInfo(IntPtr hWnd, SBFlags scrollBar,
            int min, int max, uint page, int position, int trackPosition = 0, bool fRedraw = true)
        {
            ...
            return SetScrollInfo(hWnd, scrollBar, ref si, fRedraw);
        }

        [DllImport("user32.dll")]
        public static extern int SetScrollPos(IntPtr hWnd, ScrollOrientation nBar, int nPos, bool bRedraw);
